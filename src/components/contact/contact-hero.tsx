...
import { CONTACT_CARDS } from "@/constants/contact";
                ...
                <div className="flex flex-col items-center justify-center w-full z-10">
                    ...
                    <Container delay={0.2}>
                        <p className="text-base md:text-lg font-normal text-center text-balance text-muted-foreground max-w-3xl mx-auto mt-4">
                            Have questions or want to learn more? Were here to help. Reach out to our team and lets discuss how we can support your needs
                        </p>
                    </Container>
